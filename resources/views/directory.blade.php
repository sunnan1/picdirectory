...
<head>
    ...
    <title>Telephone Directory PIC-MTI</title>
    <!-- Fonts -->
...
<script src="{!! url('/resources/js/jszip.min.js') !!}"></script>
<script src="{!! url('/resources/js/kendo.all.min.js') !!}"></script>
...
<script>
    $(document).ready(function() {
     ...
     /*   $("body").on("keyup" , "input.k-input" , delay(function (e) {
            $("#grid").data("kendoGrid").dataSource.data([]);
            $("#grid").data("kendoGrid").destroy();
            prepareGrid($(this).val())
        }));*/
        ...
        function prepareGrid(searchFilter)
        {
            $("#grid").kendoGrid({
                toolbar: ["search"],
                dataSource: {
